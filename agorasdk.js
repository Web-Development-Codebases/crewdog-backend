...
const agoraApi = express.Router();
const APP_ID = "ce0a2cf9800b467fb3d74412c2b09f21";
const APP_CERTIFICATE = "ef9a961fe85f47d7b4609ddca806005a";
...
agoraApi.options('*', cors());
agoraApi.get('/ping', nocache, ping);
agoraApi.get('/rtc/:channel/:role/:tokentype/:uid', nocache, generateRTCToken);
agoraApi.get('/rtm/:uid/', nocache, generateRTMToken);
agoraApi.get('/rte/:channel/:role/:tokentype/:uid', nocache, generateRTEToken);
